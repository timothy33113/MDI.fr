...
const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Action Card */}
      <Card
        className={`group hover:shadow-xl transition-all duration-300 cursor-pointer border-2 border-dashed border-gray-200 ${classes.border} bg-gradient-to-br ${classes.gradient}`}
        onClick={onAction}
      >
